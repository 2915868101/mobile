<template>
  <div class="srtj_fyfx g-wrap ">
    <div class="aa f-pl12 f-pr12 f-pb5">
      ...
      <template>
        <div class="f-mb10">
          <van-cell :value="tableData1.NAME1+'万人'">
            <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">常驻人口数(万人)</div>
            </template>
          </van-cell>
          <van-cell :value="tableData1.NAME2+'万份'">
            <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">电子档案建档量(万份)</div>
            </template></van-cell>
          <van-cell :value="tableData1.NAME3"> <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">电子档案建档率(%)</div>
            </template></van-cell>
          <van-cell :value="tableData1.NAME4+'万份'"> <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">档案动态使用数(万份) </div>
            </template>
          </van-cell>
        </div>
        <div class="screen-wrap" v-if="tableData" ref="table1">
          ...
          <div class="f-mt8 f-mb8 f-pr">
            <el-table :data="tableData" ref="tableData" max-width="100%" :max-height="isFullPage?getTableMaxWidth(50):getTableMaxHeight(50)" stripe :header-cell-style="{background:'#FAFAFA',color:'#283142'}">
              ...
              <el-table-column align="center" prop="VALUE2" label="辖区常住人口数(万)"></el-table-column>
              <el-table-column align="center" prop="VALUE3" label="健康档案建档数(万)"></el-table-column>
              <el-table-column align="center" prop="VALUE4" label="电子健康档案建档率(%)"></el-table-column>
              <el-table-column align="center" prop="VALUE5" label="动态累计使用数(万)"></el-table-column>
              <el-table-column align="center" prop="VALUE6" label="健康档案使用率(%)"></el-table-column>
              <el-table-column align="center" prop="VALUE7" label="老年人管理数(人)"></el-table-column>
              <el-table-column align="center" prop="VALUE8" label="糖尿病管理数(人)"></el-table-column>
              <el-table-column align="center" prop="VALUE9" label="精神障碍管理数(人)"></el-table-column>
              <el-table-column align="center" prop="VALUE10" label="健康体检人数(人)"></el-table-column>
            </el-table>
          </div>
        </div>
      </template>
  ...
  export default {
    ...
    methods: {
      ...
      getQyKsZbInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getGWJkdagl',
          params: t.searchForm,
...
<style scoped>
  ...
  .srtj_fyfx>>>.el-table__header-wrapper {
    z-index: 30;
  }

  .srtj_fyfx>>>.el-table__body-wrapper {
    z-index: 21;
    position: relative;
  }

  .srtj_fyfx>>>.el-table__fixed {
    z-index: 41;
  }

  .srtj_fyfx>>>.el-table__footer-wrapper {
    z-index: 31;
  }
