        ...
        <div class="f-mb10">
          <van-cell :value="tableData1.NAME1+'份'">
            <template #title>
              ...
              <div class="f-ml15">高血压累计建档数(份)</div>
            </template>
          </van-cell>
          ...
          <van-cell :value="tableData1.NAME4+'人'"> <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">最近一次随访血压正常人数(人)</div>
            </template>
          </van-cell>
        </div>
        ...
        <div class="screen-wrap" v-if="tableData" ref="table1">
          ...
          <div class="f-mt8 f-mb8 f-pr">
            <el-table :data="tableData" ref="tableData" max-width="100%" :max-height="isFullPage?getTableMaxWidth(50):getTableMaxHeight(50)" stripe :header-cell-style="{background:'#FAFAFA',color:'#283142'}">
              ...
              <el-table-column align="center" prop="VALUE2" label="高血压建档数(人)"></el-table-column>
              <el-table-column align="center" prop="VALUE3" label="规范管理人数"></el-table-column>
              <el-table-column align="center" prop="VALUE4" label="已随访人次数"></el-table-column>
              <el-table-column align="center" prop="VALUE5" label="随访服务完成率"></el-table-column>
              <el-table-column align="center" prop="VALUE6" label="血压控制率"></el-table-column>
              <el-table-column align="center" prop="VALUE7" label="高血压患者体检数"></el-table-column>
              <el-table-column align="center" prop="VALUE8" label="血压控制正常人数"></el-table-column>
            </el-table>
          </div>
        </div>
      </template>
  ...
  export default {
    ...
    methods: {
      ...
      getQyKsZbInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getGWGxygl',
          params: t.searchForm,
...
<style scoped>
  ...
  .mzzb_jzrc>>>.el-table__header-wrapper {
    z-index: 30;
  }

  .mzzb_jzrc>>>.el-table__body-wrapper {
    z-index: 21;
    position: relative;
  }

  .mzzb_jzrc>>>.el-table__fixed {
    z-index: 41;
  }

  .mzzb_jzrc>>>.el-table__footer-wrapper {
    z-index: 31;
  }
