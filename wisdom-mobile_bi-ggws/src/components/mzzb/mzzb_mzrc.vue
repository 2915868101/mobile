      ...
      <template>
        <div class="f-mb10">
          ...
          <van-cell :value="tableData1.NAME4+'人'"> <template #title>
              <span class="icon f-fl wsdfont wsd-yuandianf"></span>
              <div class="f-ml15">最近一次血糖达标人数(人)</div>
            </template>
          </van-cell>
        </div>
        ...
        <div class="screen-wrap" v-if="tableData" ref="table1">
          ...
          <div class="f-mt8 f-mb8 f-pr">
            <el-table :data="tableData" ref="tableData" max-width="100%" :max-height="isFullPage?getTableMaxWidth(50):getTableMaxHeight(50)" stripe :header-cell-style="{background:'#FAFAFA',color:'#283142'}">
              ...
              <el-table-column align="center" prop="VALUE2" label="糖尿病累计建档数"></el-table-column>
              <el-table-column align="center" prop="VALUE3" label="糖尿病规范管理人数"></el-table-column>
              ...
              <el-table-column align="center" prop="VALUE6" label="血糖控制率"></el-table-column>
              <el-table-column align="center" prop="VALUE7" label="糖尿病患者体检数"></el-table-column>
              <el-table-column align="center" prop="VALUE8" label="最近一次血糖达标人数"></el-table-column>
            </el-table>
          </div>
        </div>
      </template>
  ...
  export default {
    ...
    methods: {
      ...
      getQyKsZbInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getGWTnbgl',
          params: t.searchForm,
...
<style scoped>
  ...
  .mzzb_mzrc>>>.el-table__header-wrapper {
    z-index: 30;
  }

  .mzzb_mzrc>>>.el-table__body-wrapper {
    z-index: 21;
    position: relative;
  }

  .mzzb_mzrc>>>.el-table__fixed {
    z-index: 41;
  }

  .mzzb_mzrc>>>.el-table__footer-wrapper {
    z-index: 31;
  }
