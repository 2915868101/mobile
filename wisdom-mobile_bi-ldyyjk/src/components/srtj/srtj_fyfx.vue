      ...
      <el-table :data="tableData1" :max-height="isFullPage?getTableMaxHeight(50):600" border>
        ...
        <el-table-column align="center" label="操作" width="100">
          <template slot-scope="scope">
            <el-button @click="toPage(scope.row)" align="center" type="text" size="small">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div> -->
  ...
  export default {
    ...
    methods: {
      ...
      getMzrcKsInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getJkTable1',
          params: t.searchForm,
      ...
      toPage(row) {
        var t = this;
        t.linkToPage("yyzb_mzhzfd?name=" + row.name + "&startdate=" + t.searchForm.startdate + "&enddate=" + t.searchForm.enddate);
      },
    },
    mounted() {}
  }
