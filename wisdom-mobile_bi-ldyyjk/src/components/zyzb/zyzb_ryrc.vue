    ...
    <div class="s-bgcF4F5FA" ref="echart1">
      <div class="f-ml12 f-mr12 f-mt10 s-bgcfff">
        <div class="title-icon-wrap f-df f-dfj" @click="doToggle('echart1')">
          <div class="f-fs16"> <i class="wsdfont wsd-zhuzhuangtushujutu f-lh24 f-pr5"></i>区域影像月度趋势</div>
          <i class="wsdfont wsd-quanping f-fs24 f-lh24" style="color:#70AEFF"></i>
        </div>
        <div :style="{height:getTableMaxWidth(60)+'px'}">
          <chart-public2 :title="1" ref="chart1"></chart-public2>
        </div>
      </div>
    </div>
  </div>
...
<script>
  import chartPublic2 from '../util/chartPublic2' //echart1   
  ...
  export default {
    ...
    methods: {
      ...
      getMzrcKsInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getJkTable7',
          params: t.searchForm,
