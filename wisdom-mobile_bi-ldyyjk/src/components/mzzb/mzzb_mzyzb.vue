<template>
  <div class="mzzb_mzyzb g-wrap">
    ...
    <div class="table-wrap s-bgcfff" v-if="tableData1" ref="table1">
      <div class="f-df f-dfe" @click="toggleFullPage($refs['table1'],'v')"><i class="fullscreen f-mb8"></i></div>
      <el-table :data="tableData1" :max-height="isFullPage?getTableMaxHeight(50):150" border>
        <el-table-column align="center" prop="name" label="区域名称"></el-table-column>
        <el-table-column align="center" prop="value" label="次均药品费增幅(%)"></el-table-column>
      </el-table>
    </div>
    <div class="g-h20 s-bgcf4f9f9"></div>
    <div class="s-bgcfff" ref="echart1">
      <div class="title-icon-wrap f-df f-dfj" @click="doToggle('echart1')">
        <div class="f-fs18 f-fwb">所有机构次均药品费增幅</div>
...
export default {
  ...
  methods: {
    ...
    getMzrcKsInfo() {
      ...
      t.ajax({
        methods: 'post',
        url: t.WSD.serverPath1 + 'mobile/getMzfyzbInfo',
        params: t.searchForm,
