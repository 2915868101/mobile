<template>
  <div class="yyzb_swrc g-wrap">
    ...
    <div v-for="(c,i) in tableData1" :key="i" class="f-ml12 f-mr12">
      <van-cell :style="{background:[i%2==0?'':'#FAFAFA']}" :value="c.value">
        <template #title>
    ...
    <div class="s-bgcF4F5FA" ref="echart1">
      <div class="f-ml12 f-mr12 f-mt10 s-bgcfff">
        <div class="title-icon-wrap f-df f-dfj" @click="doToggle('echart1')">
          <div class="f-fs16"> <i class="wsdfont wsd-zhuzhuangtushujutu f-lh24 f-pr5"></i>远程会诊月度趋势</div>
  ...
  export default {
    ...
    methods: {
      ...
      getMzrcKsInfo() {
        ...
        t.ajax({
          methods: 'post',
          url: t.WSD.serverPath1 + 'mobile/getJkTable9',
          params: t.searchForm,
...
<style scoped>
  ...
  .yyzb_swrc .date-wrap .date-input {
    width: 41%;
  ...
  .yyzb_swrc .date-wrap .date-input i {
